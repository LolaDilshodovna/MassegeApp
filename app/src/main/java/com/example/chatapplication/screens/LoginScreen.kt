...
fun LoginScreen(navController: NavController) {
    ...
    Column(
        ...
        TextField(
            ...
            placeholder = { Text(text = "Username", fontSize = 14.sp, color = Color.White) },
            leadingIcon = {
                Icon(
        ...
        TextField(
            ...
            shape = RoundedCornerShape(5.dp),
            placeholder = { Text(text = "Password", fontSize = 14.sp, color = Color.White) },
            leadingIcon = {
                Icon(
        ...
        Button(
            ...
            Text(
                text = "Sign up",
                color = com.example.chatapplication.ui.theme.Text,
                fontSize = 14.sp,
                modifier = Modifier.padding(vertical = 8.dp)
            )
