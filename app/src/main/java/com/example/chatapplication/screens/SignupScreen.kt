...
import com.example.chatapplication.ui.theme.Tertiary
import com.example.chatapplication.ui.theme.Text2
...
fun SignupScreen(navController: NavController) {
    ...
    Column(
        ...
        TextField(value = firstName.value,
            ...
            placeholder = { Text(text = "Firstname", fontSize = 14.sp, color = Black20) },
            leadingIcon = {
                Icon(
        ...
        TextField(
            ...
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text),
            shape = RoundedCornerShape(5.dp),
            placeholder = { Text(text = "LastName (Optional)", fontSize = 14.sp, color = Black20) },
            leadingIcon = {
                Icon(
                    imageVector = Icons.Rounded.Person, contentDescription = "", tint = Black20
                )
        ...
        TextField(value = username.value,
            ...
            shape = RoundedCornerShape(5.dp),
            placeholder = {
                Text(text = "Username", fontSize = 14.sp, color = Black20)
            },
            leadingIcon = {
                Icon(
        ...
        TextField(value = password.value,
            ...
            shape = RoundedCornerShape(5.dp),
            placeholder = {
                Text(text = "Password", fontSize = 14.sp, color = Black20)
            },
            leadingIcon = {
                Icon(
...
//            },
        ...
        TextField(value = retypePassword.value,
            ...
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password),
            shape = RoundedCornerShape(5.dp),
            placeholder = { Text(text = "Retype password", fontSize = 14.sp, color = Black20) },
            leadingIcon = {
                Icon(
                    imageVector = Icons.Rounded.Lock, contentDescription = "", tint = Black20
                )
